    ...
    return (
      <div className="bg-surface-200/95 backdrop-blur-xl border border-white/10 p-4 rounded-xl shadow-xl">
        ...
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-slate-300">Goal Cost:</span>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-6">
        <div className="p-2 bg-red-500/10 rounded-lg border border-white/5">
          ...
          <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
            <defs>
              <linearGradient id="colorInflation" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#da3832" stopOpacity={0.3}/>
